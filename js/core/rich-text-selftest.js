...
// Load KaTeX UMD safely into a sandbox, then expose on globalThis
const katexCode = readFileSync(join(__dirname, '../../vendor/katex/katex.min.js'), 'utf8');
const sandbox = { module: { exports: {} }, exports: {}, console };
sandbox.self = sandbox;
sandbox.global = sandbox;
const ctx = createContext(sandbox);
runInContext(katexCode, ctx);
const katex = sandbox.katex || sandbox.module.exports || sandbox.exports?.katex || sandbox.exports;
