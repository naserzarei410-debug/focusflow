 ...
 *                  API. Free, fast, needs no API key - but on some
 *                  Android devices it either doesn't implement it at
 *                  all, or exposes the constructor but never actually
 *                  delivers a result (no on-device speech service behind it).
 *
