...
اگر کاربر «دستورالعمل اضافی» ارسال کرده باشد، آن را با اولویت بالا رعایت کن (مثلاً محدود کردن به صفحات خاص، تمرکز روی یک فصل، تعداد کارت، سطح دشواری یا نادیده گرفتن بخش‌هایی از متن). نشانگرهای [صفحه N] در متن، شمارهٔ صفحهٔ PDF هستند.
