...
export function renderMathSegment(mathText, displayMode = false) {
  ...
  // Prefer the global katex loaded from index.html / vendor (UMD build).
  let katexLib = null;
  if (typeof window !== 'undefined' && window.katex) katexLib = window.katex;
  else if (typeof globalThis !== 'undefined' && globalThis.katex) katexLib = globalThis.katex;
