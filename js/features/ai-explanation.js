...
import { openBottomSheet, createLoadingInline, showToast, createButton, renderFractionsInText, escapeHtml } from '../core/ui.js';
...
${backText}`;
  ...
  function appendBubble(sender, text, imagePreviewUrl) {
    ...
    if (text) {
      ...
      textEl.innerHTML = renderFractionsInText(escapeHtml(text).replace(/\n/g, '<br>'));
